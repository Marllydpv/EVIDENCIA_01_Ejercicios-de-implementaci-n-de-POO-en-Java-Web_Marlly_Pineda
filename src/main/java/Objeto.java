...
RequestDispatcher cr3 =req.getRequestDispatcher("agregarHistoria.jsp");
cr3.forward(req, resp);
break;
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      ...
      switch (url) {
        case "Agregar Historia":
            String titulo=req.getParameter("titulo");
            String contenido=req.getParameter("contenido");
            HistoriaCRUD histo=new HistoriaCRUD(titulo, contenido);
            req.setAttribute("histo", histo.agregarHistoria());
            RequestDispatcher cr2 =req.getRequestDispatcher("Agregar_Historias.jsp");
            break;
